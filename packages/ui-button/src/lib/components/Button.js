...
const borderRadius = props => {
  if (props.pill) {
    return css`
      border-radius: ${br(props, "button").pill};
    `;
  } else if (props.noRadius) {
    return css`
      border-radius: ${br(props, "button").noRadius};
    `;
  } else if (props.sm) {
    return css`
      border-radius: ${br(props, "button").sm};
    `;
  } else if (props.lg) {
    return css`
      border-radius: ${br(props, "button").lg};
    `;
  }

  return css`
    border-radius: ${br(props, "button").default};
  `;
};
...
const color = props => {
  ...
  return css`
    color: ${colors(props, "button").color};
  `;
};
