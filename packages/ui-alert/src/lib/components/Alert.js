...
const color = props =>
  css`
    color: ${colors(props, "alert").text};
  `;

const backgroundColor = props =>
  css`
    background-color: ${colors(props, "alert").background};
  `;

const borderColor = props =>
  css`
    border-color: ${colors(props, "alert").border};
  `;
...
const borderRadius = props => {
  if (props.noRadius) {
    return css`
      border-radius: ${br(props, "alert").noRadius};
    `;
  } else if (props.pill) {
    return css`
      border-radius: ${br(props, "alert").pill};
    `;
  }

  return css`
    border-radius: ${br(props, "alert").default};
  `;
};
