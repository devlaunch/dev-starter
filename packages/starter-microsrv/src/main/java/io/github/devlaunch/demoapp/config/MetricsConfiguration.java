...
public class MetricsConfiguration extends MetricsConfigurerAdapter
  ...
  public void init() {
    ...
    if (hikariDataSource != null) {
      ...
      // remove the factory created by HikariDataSourceMetricsPostProcessor until JHipster migrate
      // to Micrometer
    ...
    if (jHipsterProperties.getMetrics().getLogs().isEnabled()) {
      ...
      final Slf4jReporter reporter =
          Slf4jReporter.forRegistry(metricRegistry)
              ...
              .build();
      reporter.start(
          jHipsterProperties.getMetrics().getLogs().getReportFrequency(), TimeUnit.SECONDS);
    }
  }
