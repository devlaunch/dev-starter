...
public class CacheConfiguration {
  ...
  public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
    ...
    config
        .getMapConfigs()
        .put("io.github.devlaunch.demoapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
  ...
  private ManagementCenterConfig initializeDefaultManagementCenterConfig(
    ...
    managementCenterConfig.setEnabled(
        jHipsterProperties.getCache().getHazelcast().getManagementCenter().isEnabled());
    managementCenterConfig.setUrl(
        jHipsterProperties.getCache().getHazelcast().getManagementCenter().getUrl());
