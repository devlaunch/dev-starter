...
export const Display3 = styled(Text)`
  ...
  font-weight: ${themeGet("text.display3.fontWeight", theme.text.display3.fontWeight)};
  line-height: ${themeGet("text.display3.lineHeight", theme.text.display3.lineHeight)};
  color: ${themeGet("text.headings.color", theme.text.headings.color)};
  font-size: ${themeGet("text.display3.fontSize", theme.text.display3.fontSize)};
`;
