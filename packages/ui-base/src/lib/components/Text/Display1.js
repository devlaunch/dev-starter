...
export const Display1 = styled(Text)`
  ...
  font-weight: ${themeGet("text.display1.fontWeight", theme.text.display1.fontWeight)};
  line-height: ${themeGet("text.display1.lineHeight", theme.text.display1.lineHeight)};
  color: ${themeGet("text.headings.color", theme.text.headings.color)};
  font-size: ${themeGet("text.display1.fontSize", theme.text.display1.fontSize)};
`;
