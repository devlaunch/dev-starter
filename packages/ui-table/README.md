...
[![npm](https://img.shields.io/npm/v/@devlaunch/ui-table.svg?style=flat-square)](https://www.npmjs.com/package/@devlaunch/ui-table)
...
```sh
$ npm i @devlaunch/ui-table -S
```

or

```sh
$ yarn add @devlaunch/ui-table
```
