...
// Actions
export const login = createAction('LOGIN', (email, password) => agent.Auth.login(email, password));
...
export const updateAuthField = createAction('AUTH_FIELD_UPDATE', (key, value) => ({
  key,
  value,
}));
