...
import dlModal from '../feedback/modal';
import './card.css';
...
export default class extends Component {
  render() {
    const {
      modalType, editView, handleCancel, selectedCard, submitCard, updateCard,
    } = this.props;
    ...
    return (
      ...
      >
        <CardInfoWrapper id={containerId} className="dlCardWrapper" />

        <CardReactFormContainer {...cardConfig}>
          <InfoFormWrapper>
            <Form className="dlCardInfoForm">
