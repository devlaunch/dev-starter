...
export default class ComposeMail extends Component {
  ...
  render() {
    ...
    return (
      <ComposeForm className="dlComposeMailWrapper">
        <ComposeAutoComplete {...ComposeAutoCompleteTO} />
        <ComposeAutoComplete {...ComposeAutoCompleteCC} />
        <Input placeholder="Subject" className="dlInputBox" />
        <Editor {...editorOption} />
        <div className="dlComposeMailBtnWrapper">
